...
mixin _$ItemDetail {
  ...
  String get healthTips => throw _privateConstructorUsedError;
...
abstract class $ItemDetailCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'health_tips') String healthTips,
...
class _$ItemDetailImpl implements _ItemDetail {
  const _$ItemDetailImpl(
      ...
      @JsonKey(name: 'health_tips') required this.healthTips,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.healthTips, healthTips) ||
...
abstract class _ItemDetail implements ItemDetail {
  const factory _ItemDetail(
      ...
      @JsonKey(name: 'health_tips') required final String healthTips,
